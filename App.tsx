           ...
           <div className="h-full overflow-hidden flex flex-col p-4 md:p-6 overflow-y-auto bg-slate-50">
            ...
            <div className="max-w-4xl mx-auto w-full space-y-8 pb-10">
                <div className="text-center mb-6">
                    <h2 className="text-2xl font-black text-gray-800 mb-2">🚀 نسخه نهایی و امن (Secure Edition)</h2>
                    <p className="text-gray-500 text-sm">شامل: اجبار رمز هنگام نصب، قفل شدن بکاپ، رفع مشکل پرمیشن ریستور.</p>
                </div>
                ...
                <div className="bg-blue-50 border-r-4 border-blue-600 p-4 rounded shadow-sm">
                    <div className="flex items-center gap-2 font-bold text-blue-800 mb-2">
                        <ShieldCheck /> تغییرات این نسخه
                    </div>
                    <ul className="text-blue-700 text-sm list-disc list-inside">
                        <li><b>نصب:</b> بعد از توکن، حتما یوزر/پسورد برای پنل می‌گیرد.</li>
                        <li><b>بکاپ:</b> این رمز داخل فایل جیسون ذخیره می‌شود.</li>
                        <li><b>ریستور:</b> قبل از انجام، رمز را می‌پرسد و چک می‌کند.</li>
                        <li><b>باگ فیکس:</b> مشکل Permission Denied حل شد.</li>
                    </ul>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
                    ...
                    <h3 className="flex items-center gap-2 font-bold text-lg text-gray-800 mb-4">
                        <Download className="text-blue-600" /> دانلود اسکریپت جدید
                    </h3>
                    <div className="flex flex-wrap gap-3 mb-6">
                        ...
                        >
                            <Download size={20} /> دانلود install.sh (جدید)
                        </button>
                    </div>
                ...
                <div className="bg-gray-900 rounded-xl shadow-xl border border-gray-700 p-6 relative overflow-hidden">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-yellow-400 text-xs mt-2">
                            * بعد از زدن گزینه ۱ (Install)، حواستان به ترمینال باشد چون رمز عبور را می‌پرسد.
                        </p>
                    </div>
                </div>
